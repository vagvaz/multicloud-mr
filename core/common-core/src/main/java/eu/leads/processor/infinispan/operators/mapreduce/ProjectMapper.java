...
/**
 * Created with IntelliJ IDEA. User: vagvaz Date: 11/4/13 Time: 8:12 AM To change this template use
 * File | Settings | File Templates.
 */
public class ProjectMapper extends LeadsMapper<String, Tuple, String, Tuple>
  ...
  public ProjectMapper(String configString) {
    super(configString);
  }
