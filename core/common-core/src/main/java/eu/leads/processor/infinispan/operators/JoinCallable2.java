...
public class JoinCallable2<K, V> implements
  ...
  @Override public String call() throws Exception {
    ...
    try {
      //Load other data
      iterable = outerCache.getAdvancedCache().filterEntries(new AcceptAllFilter());
      ...
      while (iterator.hasNext()) {
        ...
        iterator.remove();
        String thekey =
            outerEntry.getKey().substring(outerEntry.getKey().indexOf(":") + 1, outerEntry.getKey().length());
      ...
      if (outerCacheName != null) {
        ...
        System.err.println(
            "Iterating over " + "outerCache" + " for batch resulted in Exception " + e.getClass().toString() + " " + e
                .getCause().toString() + "\n" + e.getMessage() + "\n");
        e.printStackTrace();
      }
