...
public class GenericMapReduceOperator extends MapReduceOperator {
  ...
  public GenericMapReduceOperator(Node com, InfinispanManager persistence, LogProxy log,
                                  Action action) {
  ...
  public void run() {
    ...
    GenericMapperCallable
        mapperCallable =
        new GenericMapperCallable(conf.toString(), intermediateCacheName);
