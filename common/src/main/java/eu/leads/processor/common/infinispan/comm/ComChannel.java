...
public class ComChannel {
  ...
  public void register(final String id, InfinispanComNode infinispanComNode) {
    CacheEventFilter<String, InfinispanComMessage>
        filter =
        new CacheEventFilter<String, InfinispanComMessage>() {

          @Override
          public boolean accept(String key, InfinispanComMessage oldValue, Metadata oldMetadata,
                                InfinispanComMessage newValue, Metadata newMetadata,
                                EventType eventType) {
