 ...
 * @author otrack
 *
 *         Created by vagvaz on 7/5/14. The worker node tracks updates on a stream and maintains a
 *         local sum of the updates when an update violates the its constrain, the worker informs
 *         the coodinator.
 */
