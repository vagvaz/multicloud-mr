...
public class ExecuteMapReduceJobHandler implements Handler<HttpServerRequest> {
  ...
  @Override public void handle(HttpServerRequest request) {
    ...
    ExecuteMapReduceJobReplyHandler replyHandler = new ExecuteMapReduceJobReplyHandler(reqId, request);
    ExecuteMapReduceJobBodyHandler bodyHandler = new ExecuteMapReduceJobBodyHandler(reqId, replyHandler);
  ...
  private class ExecuteMapReduceJobBodyHandler implements Handler<Buffer> {
    ...
    public ExecuteMapReduceJobBodyHandler(String requestId, ExecuteMapReduceJobReplyHandler replyHandler) {
