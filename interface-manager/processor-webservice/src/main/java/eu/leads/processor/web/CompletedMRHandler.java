...
public class CompletedMRHandler implements Handler<HttpServerRequest> {
  ...
  public void handle(HttpServerRequest request) {
    ...
    CompletedMRHandlerReplyHandler
        replyHandler =
        new CompletedMRHandlerReplyHandler(reqId, request);
    CompletedMRHandlerBodyHandler
        bodyHanlder =
        new CompletedMRHandlerBodyHandler(reqId, replyHandler);
  ...
  private class CompletedMRHandlerBodyHandler implements Handler<Buffer> {
    ...
    public CompletedMRHandlerBodyHandler(String requestId,
                                         CompletedMRHandlerReplyHandler replyHandler) {
