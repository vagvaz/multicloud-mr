 ...
 */
public class StopCacheHandler implements Handler<HttpServerRequest> {

  Node com;
  Logger log;
  Map<String, StopCacheReplyHandler> replyHandlers;


  public StopCacheHandler(final Node com, Logger log) {
    this.com = com;
    this.log = log;
  ...
  public void handle(HttpServerRequest request) {
    ...
    StopCacheReplyHandler replyHandler = new StopCacheReplyHandler(reqId, request);

    String queryId = request.params().get("cache");
    ...
    action.setLabel(IManagerConstants.STOP_CACHE);
    ...
    queryRequest.putString("cache", queryId);
  ...
  public void cleanup(String id) {
    StopCacheReplyHandler rh = replyHandlers.remove(id);
    rh = null;
  }


  private class StopCacheReplyHandler implements LeadsMessageHandler {
    HttpServerRequest request;
    String requestId;

    public StopCacheReplyHandler(String requestId, HttpServerRequest request) {
